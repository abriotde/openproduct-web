...
# !!! Main.UserApp is configured as an alias for Main.OpenproductWeb and you might encounter it in some tests
using Main.OpenproductWeb, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "OpenproductWeb tests" begin
  @includetests ARGS
end
